...
5. **Start where people already are.** Bars, kitchens, Discord servers, village squares. Meet people in their actual lives.
...
**Components:**
- Physical & digital "Third Places" optimized for deep conversation
- Ritual design (how gatherings begin, how conflict is held, how they end)
- Story elicitation and amplification tools
- "Barborn" onboarding experiences
...
## The Bar Test (Non-Negotiable)

Every proposal, feature, or governance change must pass:

> "Can this be explained to three tired, slightly drunk strangers at 1:30 AM such that they get excited, argue productively, and leave wanting to do something about it?"

If it fails the Bar Test, it goes back to the drawing board (or the napkin).
...
- Top-down control dressed as "coordination"
- Optimization for engagement or growth at the expense of depth
- Black-box algorithms deciding human futures
- Performative openness without real power sharing
- Solutions that require people to become different kinds of humans first

## How to Contribute to the Spec

This is a living document. Open an issue or pull request with:
- Proposed new axioms or components
- Real-world experiments and what you learned
- Stories of resonance (or dissonance) in the wild
- Better ways to articulate the Bar Test
